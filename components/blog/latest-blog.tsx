...
const LatestBlog = () => {
  return (
    <div className="space-y-6 lg:space-y-15">
      ...
      <div className="grid grid-cols-2 gap-4 lg:flex flex-wrap justify-between gap-6 ">
        {blogs.map((blog, idx) => (
      ...
      <div className="grid grid-cols-2 gap-4 lg:flex flex-wrap justify-between gap-6 items-center">
        {blogs.map((blog, idx) => (
          <BlogCard key={idx} {...blog} />
        ))}
      </div>
