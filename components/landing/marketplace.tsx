...
import { CircleCheck, MessageCircle, ShoppingCart } from "lucide-react";
...
const features = [
  ...
  {
    img: "https://assets.capcons.com/images/Kwik.png",
  ...
  return (
    <section className="rounded-[20px] lg:p-6 lg:bg-[#FEFCF9]">
      ...
      <div className="hidden lg:block space-y-10 relative">
        <div className="space-y-2">
          <Heading as="h2">
            Turn your <span className="bg-secondary-soft">Community</span> into
            a <br />
        ...
        <div className="grid grid-cols-2 gap-25 w-[60%]">
          {features.map((item, index) => (
        ...
        <Image
          ...
          width={500}
          height={500}
          className="object-contain absolute right-10 top-14"
        />
      </div>
    </section>
  );
